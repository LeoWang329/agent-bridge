// Open a claude session, fire a long turn non-blocking, abort it mid-flight,
// assert the session returns to idle, then prove it's reusable with a follow-up turn.
